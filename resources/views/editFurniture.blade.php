...
@section('title', 'Ubah Data Furniture')
        ...
        <div class="row justify-content-center">
            <div class="col-lg-11">
                <div class="card shadow-sm rounded-0 p-5">
                    <div class="card-body">
                        <h4 class="text-center mb-5 fw-bold">Ubah Data Furniture</h4>
                        <form>
                            <div class="row g-4 px-5">
                                ...
                                <div class="col-md-6 ">
                                    ...
                                    <input type="text" class="form-control" id="namaFurniture" placeholder="Lemari">
                                </div>
                                <div class="col-md-6 ">
                                    <label for="jumlahUnit" class="form-label">Jumlah Unit</label>
                                    <input type="number" class="form-control" id="jumlahUnit" placeholder="3">
                                </div>

                                <!-- Baris 3 -->
                                <div class="col-md-6 ">
                                    <label for="hargaUnit" class="form-label">Harga Unit</label>
                                    <input type="text" class="form-control" id="hargaUnit" placeholder="Rp 20,000,000">
                                </div>
                                <div class="col-md-6 ">
