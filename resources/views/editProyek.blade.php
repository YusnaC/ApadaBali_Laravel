        ...
        <div class="row justify-content-center">
            <div class="col-lg-11">
                <div class="card shadow-sm rounded-0 p-5">
                    <div class="card-body">
                        <h4 class="text-center mb-5 fw-bold">Ubah Data Proyek</h4>
                        <form>
                            <div class="row g-3  ">
                                <!-- Baris 1 -->
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="namaProyek" placeholder="Proyek 1">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="lokasi" class="form-label">Lokasi</label>
                                    <input type="text" class="form-control" id="lokasi" placeholder="Jl. Kamboja">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="jenis" class="form-label">Jenis</label>
                                    <input type="text" class="form-control" id="jenis" placeholder="Perumahan">
                                </div>

                                <!-- Baris 3 -->
                                <div class="col-md-4 mb-3">
                                    <label for="luas" class="form-label">Luas</label>
                                    <input type="number" class="form-control" id="luas" placeholder="500">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="jumlahLantai" class="form-label">Jumlah Lantai</label>
                                    <input type="number" class="form-control" id="jumlahLantai" placeholder="3">
                                </div>
                                <div class="col-md-4 mb-3">
