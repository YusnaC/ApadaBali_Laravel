    ...
    <div class="d-flex align-items-center">
      <div class="wrap d-flex align-items-center">
        ...
        <div class="ms-4 h-100 w-100">
          <img src="{{ asset('icon/left element.svg') }}" alt="First Icon" class="element-header-left" />
        </div>
      </div>
      <div class="d-flex align-items-center ms-auto">
        ...
        <img src="{{ asset('icon/right element.svg') }}" alt="Second Icon" class="icon" style="width: 100px; height: 50px" />
      </div>
    </div>
  </header>
</section>
