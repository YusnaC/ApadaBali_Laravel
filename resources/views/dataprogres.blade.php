            ...
            <div class="card shadow-sm rounded-0 p-5">
                <div class="card-body px-5">
                    ...
                    <form>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                <label for="id-proyek" class="form-label">Id Proyek</label>
                                <select id="id-proyek" class="form-select">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" id="progres" class="form-control">
                            </div>
                            <!-- Row 3 -->
                            <div class="mb-4">
                            ...
                            <!-- row 4 -->
                            <div class="mb-4">
                                <label for="formFileMultiple" class="form-label">Upload Dokumen</label>
