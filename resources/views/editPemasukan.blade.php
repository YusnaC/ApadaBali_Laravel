...
@section('title', 'Ubah Data Pemasukan')
            ...
            <div class="col-lg-11">
                <div class="card shadow-sm rounded-0 p-5">
                    <div class="card-body px-5">
                        <h4 class="text-center mb-5 fw-bold">Ubah Data Pemasukan</h4>
                        <form>
                        <div class="row mb-4">
                            <div class="col-md-6">
                        ...
                        <div class="row mb-4">
                            ...
                            <input type="number" class="form-control" id="jumlah" placeholder="Rp 20,000,000">
                            </div>
                        </div>
                        <div class="mb-4">
                            <label for="termin" class="form-label">Termin</label>
                            <input type="number" id="termin" class="form-control"  placeholder="1">
                        </div>
                        <div class="mb-4">
                            <label for="keterangan" class="form-label">Keterangan</label>
                            <textarea id="keterangan" class="form-control custom-textarea" rows="3"  placeholder="Pembayaran Awal"></textarea>
                        </div>
